...
<div class="sidebar floating-sidebar d-flex flex-column p-3">
  ...
  <ul class="nav nav-pills flex-column mb-auto">
    ...
    <li><a href="kelola-user.php" class="nav-link text-dark"><i class="bi bi-person-fill-gear me-2"></i>User</a></li>
  </ul>
  <hr>
  <a href="../config/logout.php" class="text-danger text-decoration-none"><i class="bi bi-box-arrow-left me-2"></i>Logout</a>
  <div class="mt-3 text-dark">
    <i class="bi bi-person-circle me-2"></i>Selamat Datang Admin : <strong><?= htmlspecialchars($nama_petugas ?? '') ?></strong>
  </div>
</div>
